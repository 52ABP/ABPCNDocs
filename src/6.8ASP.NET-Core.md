...
你可以从[Startup Template](https://www.52abp.com/Download/Index)来创建你的项目，该模板是一个空置且简单的web项目，它预先集成且配置好一切可以与ABP框架一起运行。
...
#### Audit Action Filter
 ...
 [审计日志](4.7ABP应用层-审计日志.md) 集成了 **AbpAuditActionFilter** 过滤器，默认记录所有对Action的请求。你可以在Action或者Controller上使用特性: **Audited和DisableAuditing** 来控制是否记录日志。
